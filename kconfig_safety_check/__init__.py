...
def add_kconfig_checks(l, arch):
    ...
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_SG', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'BUG_ON_DATA_CORRUPTION', 'y')]
    l += [KconfigCheck('elisa_safety', 'Intel', 'KMEM', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety, Intel', 'DEVMEM', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety, Intel', 'DEVPORT', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'ACPI_CUSTOM_METHOD', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'LEGACY_PTYS', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'HIBERNATION', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'KEXEC', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety, Intel', 'HARDENED_USERCOPY', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'HARDENED_USERCOPY_FALLBACK', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'HARDENED_USERCOPY_PAGESPAN', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'SECURITY_DMESG_RESTRICT', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'COMPAT_BRK', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'USERFAULTFD', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'STRICT_KERNEL_RWX', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'STRICT_MODULE_RWX', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_WX', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'STACKTRACE_SUPPORT', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'STACK_TRACER', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'KPROBES', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'PROC_KCORE', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'ELF_CORE', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'PROC_PAGE_MONITOR', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'FTRACE_SYSCALLS', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'KALLSYMS', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'SOFTLOCKUP_DETECTOR', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DETECT_HUNG_TASK', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'WQ_WATCHDOG', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'KCSAN', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'PROVE_LOCKING', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_RT_MUTEXES', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_NOTIFIERS', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'LOCK_STAT', 'y')]
    l += [KconfigCheck('DEBUG', 'elisa_safety', 'DEBUG_SPINLOCK', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_MUTEXES', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_WW_MUTEX_SLOWPATH', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_LOCK_ALLOC', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_LOCKING_API_SELFTESTS', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'LOCK_TORTURE_TEST', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'WW_MUTEX_SELFTEST', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'RCU_TORTURE_TEST', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEBUG_ATOMIC_SLEEP', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'SIGNALFD', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'RETPOLINE', 'y')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'BPF_UNPRIV_DEFAULT_OFF', 'n')]
    l += [KconfigCheck('elisa_safety', 'elisa_safety', 'LIVEPATCH', 'n')]


    if arch in ('X86_64', 'X86_32'):
        l += [KconfigCheck('elisa_safety', 'elisa_safety', 'DEVKMEM', 'y')]
        l += [KconfigCheck('elisa_safety', 'elisa_safety', 'PAGE_TABLE_ISOLATION', 'y')]
    if arch in ('ARM', 'ARM64'):
        l += [KconfigCheck('elisa_safety', 'elisa_safety', 'UNMAP_KERNEL_AT_EL0', 'y')]
        l += [KconfigCheck('elisa_safety', 'elisa_safety', 'HARDEN_BRANCH_PREDICTOR', 'y')]
        l += [KconfigCheck('elisa_safety', 'elisa_safety', 'HARDEN_EL2_VECTORS', 'y')]
        l += [KconfigCheck('elisa_safety', 'elisa_safety', 'ARM64_SSBD', 'y')]
